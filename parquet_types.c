      ...
      case 3:
        if (ftype == T_I32)
        {
          ...
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast1, error)) < 0)
            return -1;
          xfer += ret;
          this_object->repetition_type = (FieldRepetitionType)ecast1;
      ...
      case 6:
        if (ftype == T_I32)
        {
          ...
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast2, error)) < 0)
            return -1;
          xfer += ret;
          this_object->converted_type = (ConvertedType)ecast2;
      ...
      case 2:
        if (ftype == T_I32)
        {
          ...
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast3, error)) < 0)
            return -1;
          xfer += ret;
          this_object->encoding = (Encoding)ecast3;
          isset_encoding = TRUE;
        } else {
          if ((ret = thrift_protocol_skip (protocol, ftype, error)) < 0)
            return -1;
      ...
      case 3:
        if (ftype == T_I32)
        {
          ...
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast4, error)) < 0)
            return -1;
          xfer += ret;
          this_object->definition_level_encoding = (Encoding)ecast4;
      ...
      case 4:
        if (ftype == T_I32)
        {
          ...
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast5, error)) < 0)
            return -1;
          xfer += ret;
          this_object->repetition_level_encoding = (Encoding)ecast5;
      ...
      case 2:
        if (ftype == T_I32)
        {
          ...
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast6, error)) < 0)
            return -1;
          xfer += ret;
          this_object->encoding = (Encoding)ecast6;
          isset_encoding = TRUE;
        } else {
          if ((ret = thrift_protocol_skip (protocol, ftype, error)) < 0)
            return -1;
      ...
      case 1:
        if (ftype == T_I32)
        {
          ...
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast8, error)) < 0)
            return -1;
          xfer += ret;
          this_object->type = (PageType)ecast8;
          isset_type = TRUE;
        } else {
          if ((ret = thrift_protocol_skip (protocol, ftype, error)) < 0)
            return -1;
      ...
      case 1:
        if (ftype == T_I32)
        {
          ...
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast9, error)) < 0)
            return -1;
          xfer += ret;
          this_object->page_type = (PageType)ecast9;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              Encoding* _elem12 = g_new (Encoding, 1);
              gint32 ecast13;
              if ((ret = thrift_protocol_read_i32 (protocol, &ecast13, error)) < 0)
                return -1;
              xfer += ret;
              *_elem12 = (Encoding)ecast13;
              g_array_append_vals (this_object->encodings, _elem12, 1);
              g_free (_elem12);
            }
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              if ((ret = thrift_protocol_read_string (protocol, &_elem14, error)) < 0)
                return -1;
              xfer += ret;
              g_ptr_array_add (this_object->path_in_schema, _elem14);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
      ...
      case 4:
        if (ftype == T_I32)
        {
          ...
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast15, error)) < 0)
            return -1;
          xfer += ret;
          this_object->codec = (CompressionCodec)ecast15;
          isset_codec = TRUE;
        } else {
          if ((ret = thrift_protocol_skip (protocol, ftype, error)) < 0)
            return -1;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              KeyValue * _elem16 = NULL;
              if ( _elem16 != NULL)
              {
                g_object_unref (_elem16);
              }
              _elem16 = g_object_new (TYPE_KEY_VALUE, NULL);
              ...
              xfer += ret;
              g_ptr_array_add (this_object->key_value_metadata, _elem16);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              PageEncodingStats * _elem17 = NULL;
              if ( _elem17 != NULL)
              {
                g_object_unref (_elem17);
              }
              _elem17 = g_object_new (TYPE_PAGE_ENCODING_STATS, NULL);
              ...
              xfer += ret;
              g_ptr_array_add (this_object->encoding_stats, _elem17);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
...
column_meta_data_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    if ((ret = thrift_protocol_write_list_begin (protocol, T_I32, (gint32) (this_object->encodings ? this_object->encodings->len : 0), error)) < 0)
      return -1;
    xfer += ret;
    for (i18 = 0; i18 < (this_object->encodings ? this_object->encodings->len : 0); i18++)
    {
      if ((ret = thrift_protocol_write_i32 (protocol, (gint32) (g_array_index (this_object->encodings, Encoding, i18)), error)) < 0)
        return -1;
      xfer += ret;
  ...
  xfer += ret;
  {
    ...
    if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (this_object->path_in_schema ? this_object->path_in_schema->len : 0), error)) < 0)
      return -1;
    xfer += ret;
    for (i19 = 0; i19 < (this_object->path_in_schema ? this_object->path_in_schema->len : 0); i19++)
    {
      if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) this_object->path_in_schema, i19)), error)) < 0)
        return -1;
      xfer += ret;
  ...
  if (this_object->__isset_key_value_metadata == TRUE) {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRUCT, (gint32) (this_object->key_value_metadata ? this_object->key_value_metadata->len : 0), error)) < 0)
        return -1;
      xfer += ret;
      for (i20 = 0; i20 < (this_object->key_value_metadata ? this_object->key_value_metadata->len : 0); i20++)
      {
        if ((ret = thrift_struct_write (THRIFT_STRUCT ((g_ptr_array_index ((GPtrArray *) this_object->key_value_metadata, i20))), protocol, error)) < 0)
          return -1;
        xfer += ret;
  ...
  if (this_object->__isset_encoding_stats == TRUE) {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRUCT, (gint32) (this_object->encoding_stats ? this_object->encoding_stats->len : 0), error)) < 0)
        return -1;
      xfer += ret;
      for (i21 = 0; i21 < (this_object->encoding_stats ? this_object->encoding_stats->len : 0); i21++)
      {
        if ((ret = thrift_struct_write (THRIFT_STRUCT ((g_ptr_array_index ((GPtrArray *) this_object->encoding_stats, i21))), protocol, error)) < 0)
          return -1;
        xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              if ((ret = thrift_protocol_read_string (protocol, &_elem22, error)) < 0)
                return -1;
              xfer += ret;
              g_ptr_array_add (this_object->path_in_schema, _elem22);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ColumnChunk * _elem24 = NULL;
              if ( _elem24 != NULL)
              {
                g_object_unref (_elem24);
              }
              _elem24 = g_object_new (TYPE_COLUMN_CHUNK, NULL);
              ...
              xfer += ret;
              g_ptr_array_add (this_object->columns, _elem24);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              SortingColumn * _elem25 = NULL;
              if ( _elem25 != NULL)
              {
                g_object_unref (_elem25);
              }
              _elem25 = g_object_new (TYPE_SORTING_COLUMN, NULL);
              ...
              xfer += ret;
              g_ptr_array_add (this_object->sorting_columns, _elem25);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
...
row_group_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    if ((ret = thrift_protocol_write_list_begin (protocol, T_STRUCT, (gint32) (this_object->columns ? this_object->columns->len : 0), error)) < 0)
      return -1;
    xfer += ret;
    for (i26 = 0; i26 < (this_object->columns ? this_object->columns->len : 0); i26++)
    {
      if ((ret = thrift_struct_write (THRIFT_STRUCT ((g_ptr_array_index ((GPtrArray *) this_object->columns, i26))), protocol, error)) < 0)
        return -1;
      xfer += ret;
  ...
  if (this_object->__isset_sorting_columns == TRUE) {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRUCT, (gint32) (this_object->sorting_columns ? this_object->sorting_columns->len : 0), error)) < 0)
        return -1;
      xfer += ret;
      for (i27 = 0; i27 < (this_object->sorting_columns ? this_object->sorting_columns->len : 0); i27++)
      {
        if ((ret = thrift_struct_write (THRIFT_STRUCT ((g_ptr_array_index ((GPtrArray *) this_object->sorting_columns, i27))), protocol, error)) < 0)
          return -1;
        xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              PageLocation * _elem28 = NULL;
              if ( _elem28 != NULL)
              {
                g_object_unref (_elem28);
              }
              _elem28 = g_object_new (TYPE_PAGE_LOCATION, NULL);
              ...
              xfer += ret;
              g_ptr_array_add (this_object->page_locations, _elem28);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
...
offset_index_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    if ((ret = thrift_protocol_write_list_begin (protocol, T_STRUCT, (gint32) (this_object->page_locations ? this_object->page_locations->len : 0), error)) < 0)
      return -1;
    xfer += ret;
    for (i29 = 0; i29 < (this_object->page_locations ? this_object->page_locations->len : 0); i29++)
    {
      if ((ret = thrift_struct_write (THRIFT_STRUCT ((g_ptr_array_index ((GPtrArray *) this_object->page_locations, i29))), protocol, error)) < 0)
        return -1;
      xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              if ((ret = thrift_protocol_read_bool (protocol, &*_elem30, error)) < 0)
                return -1;
              xfer += ret;
              g_array_append_vals (this_object->null_pages, _elem30, 1);
              g_free (_elem30);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              g_free (data);
              g_ptr_array_add (this_object->min_values, _elem31);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              g_free (data);
              g_ptr_array_add (this_object->max_values, _elem32);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
      ...
      case 4:
        if (ftype == T_I32)
        {
          ...
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast33, error)) < 0)
            return -1;
          xfer += ret;
          this_object->boundary_order = (BoundaryOrder)ecast33;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              gint64* _elem34 = g_new (gint64, 1);
              if ((ret = thrift_protocol_read_i64 (protocol, &*_elem34, error)) < 0)
                return -1;
              xfer += ret;
              g_array_append_vals (this_object->null_counts, _elem34, 1);
              g_free (_elem34);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
...
column_index_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    if ((ret = thrift_protocol_write_list_begin (protocol, T_BOOL, (gint32) (this_object->null_pages ? this_object->null_pages->len : 0), error)) < 0)
      return -1;
    xfer += ret;
    for (i35 = 0; i35 < (this_object->null_pages ? this_object->null_pages->len : 0); i35++)
    {
      if ((ret = thrift_protocol_write_bool (protocol, (g_array_index (this_object->null_pages, gboolean, i35)), error)) < 0)
        return -1;
      xfer += ret;
  ...
  xfer += ret;
  {
    ...
    if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (this_object->min_values ? this_object->min_values->len : 0), error)) < 0)
      return -1;
    xfer += ret;
    for (i36 = 0; i36 < (this_object->min_values ? this_object->min_values->len : 0); i36++)
    {
      if ((ret = thrift_protocol_write_binary (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) this_object->min_values, i36)) ? ((GByteArray *) ((gchar*)g_ptr_array_index ((GPtrArray *) this_object->min_values, i36)))->data : NULL, ((gchar*)g_ptr_array_index ((GPtrArray *) this_object->min_values, i36)) ? ((GByteArray *) ((gchar*)g_ptr_array_index ((GPtrArray *) this_object->min_values, i36)))->len : 0, error)) < 0)
        return -1;
      xfer += ret;
  ...
  xfer += ret;
  {
    ...
    if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (this_object->max_values ? this_object->max_values->len : 0), error)) < 0)
      return -1;
    xfer += ret;
    for (i37 = 0; i37 < (this_object->max_values ? this_object->max_values->len : 0); i37++)
    {
      if ((ret = thrift_protocol_write_binary (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) this_object->max_values, i37)) ? ((GByteArray *) ((gchar*)g_ptr_array_index ((GPtrArray *) this_object->max_values, i37)))->data : NULL, ((gchar*)g_ptr_array_index ((GPtrArray *) this_object->max_values, i37)) ? ((GByteArray *) ((gchar*)g_ptr_array_index ((GPtrArray *) this_object->max_values, i37)))->len : 0, error)) < 0)
        return -1;
      xfer += ret;
  ...
  if (this_object->__isset_null_counts == TRUE) {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_I64, (gint32) (this_object->null_counts ? this_object->null_counts->len : 0), error)) < 0)
        return -1;
      xfer += ret;
      for (i38 = 0; i38 < (this_object->null_counts ? this_object->null_counts->len : 0); i38++)
      {
        if ((ret = thrift_protocol_write_i64 (protocol, (g_array_index (this_object->null_counts, gint64, i38)), error)) < 0)
          return -1;
        xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              SchemaElement * _elem39 = NULL;
              if ( _elem39 != NULL)
              {
                g_object_unref (_elem39);
              }
              _elem39 = g_object_new (TYPE_SCHEMA_ELEMENT, NULL);
              ...
              xfer += ret;
              g_ptr_array_add (this_object->schema, _elem39);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              RowGroup * _elem40 = NULL;
              if ( _elem40 != NULL)
              {
                g_object_unref (_elem40);
              }
              _elem40 = g_object_new (TYPE_ROW_GROUP, NULL);
              ...
              xfer += ret;
              g_ptr_array_add (this_object->row_groups, _elem40);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              KeyValue * _elem41 = NULL;
              if ( _elem41 != NULL)
              {
                g_object_unref (_elem41);
              }
              _elem41 = g_object_new (TYPE_KEY_VALUE, NULL);
              ...
              xfer += ret;
              g_ptr_array_add (this_object->key_value_metadata, _elem41);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ColumnOrder * _elem42 = NULL;
              if ( _elem42 != NULL)
              {
                g_object_unref (_elem42);
              }
              _elem42 = g_object_new (TYPE_COLUMN_ORDER, NULL);
              ...
              xfer += ret;
              g_ptr_array_add (this_object->column_orders, _elem42);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
...
file_meta_data_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    if ((ret = thrift_protocol_write_list_begin (protocol, T_STRUCT, (gint32) (this_object->schema ? this_object->schema->len : 0), error)) < 0)
      return -1;
    xfer += ret;
    for (i43 = 0; i43 < (this_object->schema ? this_object->schema->len : 0); i43++)
    {
      if ((ret = thrift_struct_write (THRIFT_STRUCT ((g_ptr_array_index ((GPtrArray *) this_object->schema, i43))), protocol, error)) < 0)
        return -1;
      xfer += ret;
  ...
  xfer += ret;
  {
    ...
    if ((ret = thrift_protocol_write_list_begin (protocol, T_STRUCT, (gint32) (this_object->row_groups ? this_object->row_groups->len : 0), error)) < 0)
      return -1;
    xfer += ret;
    for (i44 = 0; i44 < (this_object->row_groups ? this_object->row_groups->len : 0); i44++)
    {
      if ((ret = thrift_struct_write (THRIFT_STRUCT ((g_ptr_array_index ((GPtrArray *) this_object->row_groups, i44))), protocol, error)) < 0)
        return -1;
      xfer += ret;
  ...
  if (this_object->__isset_key_value_metadata == TRUE) {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRUCT, (gint32) (this_object->key_value_metadata ? this_object->key_value_metadata->len : 0), error)) < 0)
        return -1;
      xfer += ret;
      for (i45 = 0; i45 < (this_object->key_value_metadata ? this_object->key_value_metadata->len : 0); i45++)
      {
        if ((ret = thrift_struct_write (THRIFT_STRUCT ((g_ptr_array_index ((GPtrArray *) this_object->key_value_metadata, i45))), protocol, error)) < 0)
          return -1;
        xfer += ret;
  ...
  if (this_object->__isset_column_orders == TRUE) {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_STRUCT, (gint32) (this_object->column_orders ? this_object->column_orders->len : 0), error)) < 0)
        return -1;
      xfer += ret;
      for (i46 = 0; i46 < (this_object->column_orders ? this_object->column_orders->len : 0); i46++)
      {
        if ((ret = thrift_struct_write (THRIFT_STRUCT ((g_ptr_array_index ((GPtrArray *) this_object->column_orders, i46))), protocol, error)) < 0)
          return -1;
        xfer += ret;
